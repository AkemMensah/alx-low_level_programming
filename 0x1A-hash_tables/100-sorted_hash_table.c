...
/**
 * sorted_list - funct that inserts new node in sorted
...
/**
 * shash_table_set - funct that adds an element to sorted hash table
 * @ht: ptr to sorted hash table
...
/**
 * shash_table_get - funct that retrieves value associeted with key
...
/**
 * shash_table_print - funct that prints the key:value from ht
 * @ht: ptr to hash table
 *
 */
...
/**
 * shash_table_print_rev - funct that prints the key:value from ht in reverse
 * @ht: ptr to hash table
 *
 */
...
/**
 * shash_table_delete - funct that frees hash table and all nodes
 * @ht: ptr to hash table
 *
 */
